...
## time range: 2016-06-10 to 2017-05-10
dt = ['20160610','20160710','20160810',
...
for date in dt:
    ...
    query_temp = talos.Query(sql_neg.format(dt = date),
                             dump='/Users/hongbo/PycharmProjects/DecisionTree/data/neg_' + date + '.txt')
    query_temp.start()

    print date, " start !"

    querys.append(query_temp)

print querys

for query_temp in querys:
